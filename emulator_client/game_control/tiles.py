...
def get_distance_between_tiles(x1: int, y1: int, x2: int, y2: int) -> float:
    """
    Get the distance between two tiles.

    Args:
        x1 (int): The x coordinate of the first tile.
        y1 (int): The y coordinate of the first tile.
        x2 (int): The x coordinate of the second tile.
        y2 (int): The y coordinate of the second tile.

    Returns:
        float: The distance between the two tiles.
    """
